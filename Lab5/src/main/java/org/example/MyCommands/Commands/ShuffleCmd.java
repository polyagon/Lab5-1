...
public class ShuffleCmd extends AbstractCmd{

    private String description = "перемешать коллекцию";
    ...
    public ShuffleCmd(CollectionManager collection, InputHandler input, OutputHandler output){
    ...
    public void execute(){
        if(checkArgs())  output.println(collection.shuffle());
    }
}
