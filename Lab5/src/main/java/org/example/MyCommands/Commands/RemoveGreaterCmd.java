...
public class RemoveGreaterCmd extends AbstractCmd{
    ...
    public RemoveGreaterCmd(CollectionManager collection, InputHandler input, OutputHandler output, ObjectReflect tree){
    ...
    public String help(){
        return "remove_greater {element}: " + description;
    }
    ...
    public void execute(){
        if(checkArgs()) {
            ...
            collection.remove_greater(newElem.buildDialogue(tree));
        }
    }
}
