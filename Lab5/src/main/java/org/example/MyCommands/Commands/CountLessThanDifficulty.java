...
public class CountLessThanDifficulty extends AbstractCmd{
    ...
    public CountLessThanDifficulty(CollectionManager collection, InputHandler input, OutputHandler output){
    ...
    public String help(){
        return "count_less_than_difficulty difficulty: " + description;
    }
    ...
    public void execute(){
        if(checkArgs())  output.println(collection.count_less_than_difficulty(Converter.DifficultyConvert(args.get(0))));
    }
}
