...
public class Converter {
    ...
    public static Difficulty DifficultyConvert(String str){
        if(str == "Difficulty.HARD") return Difficulty.HARD;
        if(str == "Difficulty.VERY_EASY") return Difficulty.VERY_EASY;
        if(str == "Difficulty.VERY_HARD") return Difficulty.VERY_HARD;
        if(str == "Difficulty.IMPOSSIBLE") return Difficulty.IMPOSSIBLE;
